...
public class HomeAdapter extends RecyclerView.Adapter<MyViewHolderHome> {
    private Context context;
    private List<ClassDataHome> dataList;
    public void setSearchList(List<ClassDataHome> dataSearchList){
        this.dataList = dataSearchList;
        notifyDataSetChanged();
    }
    public HomeAdapter(Context context, List<ClassDataHome> dataList){
    ...
    public MyViewHolderHome onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rcyc_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolderHome holder, int position) {
        ...
        holder.recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, DetActivity.class);
